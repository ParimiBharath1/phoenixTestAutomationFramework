...
public class CreateJobApiDataDrivenFakegenerator {
	
private JobService jobService;
	
	@BeforeMethod(description = "Creating jobservice instance")
	public void setup() {
		jobService = new JobService();
	}
	
 
	@Test(description = "Verifying if the Create Job is Able to create In-Warranty jobs", groups = { "api", "regression","smoke","faker" },
