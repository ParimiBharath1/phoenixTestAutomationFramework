...
public class CreateJobApiwithfakeDataDBValidation {
	...
	@BeforeMethod(description = "Creating Create job api request Payload and also job create instance")
	public void setup() {
	...
	public void createJobApiTest() {
		...
		Integer CustomerId = jobService.createJob(Role.FD, createJobPayload).then().spec(responseSpec_OK())
		...
		CustomerAddressDBModel customerAddressActual = CustomerAddressDao
				.getCustomerAddress(customerActual.getTr_customer_address_id());
		...
		// jobHeadModelfromDB.getMst_service_location_id());
